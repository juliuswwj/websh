...
func TestSpawnPlumbing(t *testing.T) {
	...
	spec := config.SessionSpec{ID: "plumb", Type: "local", Name: "test"}
...
func TestBuildArgvSSH(t *testing.T) {
	spec := config.SessionSpec{ID: "x", Type: "ssh", Host: "h.example", User: "deploy", Port: 2222, SSHOptions: []string{"-o", "ServerAliveInterval=30"}}
